...
<body>
    <div id="app">
        ...
        <div class="all_container">
            <div class="table-container">
                <?php include 'components/tables/add_equipment_table.php'; ?>
            </div>

            <section class="section main-section">
                <?php include 'components/forms/add_equipment_form.php'; ?>
            </section>
        </div>
    </div>
    ...
    <script type="text/javascript" src="../public/js/admin_scripts/equipment_management.js"></script>
