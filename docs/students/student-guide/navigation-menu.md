---
description: >-
  A navigation panel that provides quick access to all system modules and
  features, allowing users to move efficiently between dashboards, reports, and
  management tools.
---
