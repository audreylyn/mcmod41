...
include 'includes/manage_teachers.php'
?>
...
<body>
    <div id="app">
        ...
        <div class="main-container">
            ...
            <?php include 'components/main_contents/manage_teachers.php'; ?>
    ...
    <script type="text/javascript" src="../public/js/admin_scripts/manage_teachers.js"></script>
